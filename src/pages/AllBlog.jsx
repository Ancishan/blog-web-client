...
// console.log(search)
  return (
    <div className='container pl-16 pt-32 mx-auto min-h-[calc(100vh-306px)] flex flex-col justify-between'>
      <h2 className="text-3xl pt-10 pb-16 text-center font-extrabold text-blue-500 ">This Whole Blog Is For You</h2>
      <div>
        <div className='flex flex-col md:flex-row justify-center items-center gap-5 '>
          <div>
            <select
             ...
             value={filter}
              name='category'
              id='category'             
              className='border p-4 rounded-lg text-xl text-blue-500'
            >
          ...
          <form className="text-blue-500" onSubmit={handleSearch}>
            <div className='flex p-1 overflow-hidden border rounded-lg    focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300'>
              ...
              <button className='px-1 md:px-4 py-3 text-sm font-medium tracking-wider text-blue-500 uppercase transition-colors duration-300 transform bg-blue-300 rounded-md hover:bg-gray-600 focus:bg-gray-600 focus:outline-none'>
                Search
              </button>
            </div>
          </form>
       
          <button onClick={handleReset} className='btn text-blue-500 font-bold'>Reset</button>
        </div>
